    ...
    <div className='flex flex-col gap-8'>
      <EnterAnimate type='slideRight'>
        <span className='text-base text-[var(--heading)]'>
          Tailor your hydraulic systems with our premium components: Pumps, PTOs, Cylinders, and Custom Assemblies. Perfectly engineered for your excavators, forklifts, dump
